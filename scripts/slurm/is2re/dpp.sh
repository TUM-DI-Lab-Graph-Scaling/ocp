...
srun python -u -m torch.distributed.launch --nproc_per_node=8 main.py \
  --distributed --num-gpus 8 --mode train --config-yml configs/is2re/100k/dimenet_plus_plus/dpp.yml \
  --deepspeed-config configs/is2re/100k/dimenet_plus_plus/ds_config.json
